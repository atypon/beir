...
from experiments.experiment import RerankBiCrossEncodersExperiment
...
if __name__ == '__main__':
    ...
    experiment = RerankBiCrossEncodersExperiment(datasets=dataset_configs['datasets'],
                                                 datasets_path=dataset_configs['datasets_path'],
                                                 bi_batch_size=dataset_configs['batch_size'],
